    ...
    def precor(self):
        ...
        for i in range (2,self.neta+1):
            ...
            if(i != 2):
                ...
                # plotting data
                if self.option == 1:
                    exp1[i-1] = (ep1-xep1)/self.dxi
                    
                ep2 = 0.5*(ep2 + xep2-self.dxi*etaxp*den1*(e2pc-e2mc) \
                    -self.dxi*etar*den1*(f2pc-f2mc)+self.dxi*h2)
                # plotting data
                if self.option == 2:
                    exp1[i-1] = (ep2-xep2)/self.dxi
                elif self.option == 4:
                    exp1[i-1] = (e1pc -e1mc)*den1
                elif self.option == 5:
                    exp1[i-1] = (e2pc - e1mc)*den1
                elif self.option == 6:
                    exp1[i-1] = (e3pc-e3mc)*den1
                elif self.option == 7:
                    exp1[i-1] = (f1pc-f1mc)*den1
                elif self.option == 8:
                    exp1[i-1] = (f2pc - f1mc)*den1
                elif self.option == 9:
                    exp1[i-1] = (f3pc - f3mc)*den1

                ep3 = 0.5*(ep3 + xep3-self.dxi*etaxp*den1*(e3pc-e3mc) \
                    -self.dxi*etar*den1*(f3pc-f3mc)+self.dxi*h3)
                # plotting data
                if self.option == 3:
                    exp1[i-1] = (ep3-xep3)/self.dxi
        ...
        # plot the data array now
        if self.x[2] > self.xplot:
            self.plotData(exp1,self.x[2])
